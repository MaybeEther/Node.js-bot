...
var whiteList = [
    ...
    "9cb5f569-6f3d-4dcd-8135-85f04acb36e6", //Krazykev
];
...
bot.on("login", function() {
    console.log("Current bot version: " + config.botversion)
...
} else if (command == "end_bot") {

    const Killbot = new Discord.MessageEmbed()
        .setDescription(`:white_check_mark: Bot has been successfull ended, its will automatic restart in 10 seconds`) 
        .setColor(color)
    process.exit(0)

    message.channel.send(Killbot)
}
